...
function m_package(pluginlist) {
  ...
  if (hadError) {
    ...
    Object.setPrototypeOf(Image.prototype, res);
    console.log("Added all plugins successfully");
  }
}
class Presentation {
  /**
...
const click_sleep = (element, listenerName = "click") =>
  new Promise((resolve, reject) => {
    var listener = (event) => {
      document
        .querySelector(element)
        .removeEventListener(listenerName, listener);
      resolve(event);
    };
    document.querySelector(element).addEventListener(listenerName, listener);
  });
